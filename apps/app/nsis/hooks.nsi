...
!macro NSIS_HOOK_PREINSTALL
    ...
    ${If} ${FileExists} "$SMPROGRAMS\${PRODUCTNAME}.lnk"
        ...
        Pop $0
        ${If} $0 != "Admin"
            MessageBox MB_ICONINFORMATION|MB_OK "An old installation of ModBridge was detected that requires administrator permission to update from. You will be prompted with an admin prompt shortly."
        ${EndIf}
